...
$(document).ready( function(){
    ...
    /*$("[id^=btn-delete-msg]").on("click", function(){
        console.log("deleting with click!")
        id = $(this).attr('id').substring(15)
        deleteMessage(id)
        return false;
    })*/

    /*$("[id^=btn-delete-com]").click( function(){
        id = $(this).attr('id').substring(15)
        deleteComment(id)
        return false;
    })*/
    ...
    /*$("[id^=btn-submit-comment]").click( function(){
        id = $(this).attr('id').substring(19)
        if (document.getElementById("comment-"+id).value != ''){
            postComment(id)
        };
